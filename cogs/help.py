...
class HelpModule(commands.Cog):
    ...
    async def evolution(self, inter:disnake.CommandInter):
        ...
        await inter.send(embed=tt.constructor_embed(titre="Assistance du bot", description="Vous avez un souci avec le bot ? N'hésitez pas à envoyé un message à Ashz#6909, ou bien rejoindre le serveur support : https://discord.gg/BVnZMzZjSC"
